...
![配图](./images/build_explicit_built_modules_after.png)
...
最后，还可以使用 `@Tag`，`@Suite` 来更好地管理测试集，关于 Swift Testing 如果想了解更多，可以参看 [Session 10179 - Meet Swift Testing](https://developer.apple.com/videos/play/wwdc2024/10179/) 和 [Session 10195 - Go further with Swift Testing](https://developer.apple.com/videos/play/wwdc2024/10195)。
...
另外，现在 Xcode 包更小，目前 (Xcode 16 Beta 1) 下载大小由 Xcode 15.4(15F31d) 的 3.43GB 减小到 2.82 GB。并且在当模拟器下载遇到错误而中断时，现在可以恢复下载。
...
想要了解更多可以查看 [Xcode 16 Release Note](https://developer.apple.com/documentation/Updates/Xcode)，当然更好的办法是立刻下载 Xcode 16 来尝试一下。
