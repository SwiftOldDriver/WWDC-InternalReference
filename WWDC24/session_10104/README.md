...
# WWDC24 10104 - 使用 RealityKit 构建空间绘画 App
...
> 有关 `LowLevelMesh` 的更多内容，可以参考[Dynamic RealityKit Meshes with LowLevelMesh](https://github.com/metal-by-example/metal-spatial-dynamic-mesh/tree/master)。
