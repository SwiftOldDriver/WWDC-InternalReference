...
![](images/session_110338_01.png)

![](images/session_110338_02.png)

![](images/session_110338_03.png)

另外，无论使用什么设备进行播放，与之配对的 Apple Watch 上的 Now Playing App 都提供相同的体验。它甚至还内置了 Apple TV 遥控器。

![](images/session_110338_04.png)
...
![](images/session_110338_05.png)

![](images/session_110338_06.png)

![](images/session_110338_07.png)

![](images/session_110338_08.png)

最后，在 iOS 的“控制其他扬声器”（Control Other Speakers）和 TV 按钮上，可以浏览所有设备上 Now Playing 的信息，并控制其播放。

![](images/session_110338_09.png)

随着在 Now Playing 中展示信息、可控制播放的设备的增加，正确发布 Now Playing 的信息和响应远程命令就尤为重要了。

![](images/session_110338_10.png)
...
![](images/session_110338_11.png)

![](images/session_110338_12.png)

![](images/session_110338_13.png)
...
![IMG_892](images/Notification_Lyrics.png)

这种样式就单调很多，实现也很简单，管理好 `UNUserNotificationCenter` 即可，还支持修改和删除已发送的通知。致于效果是否讨人喜欢，就见仁见智了。
