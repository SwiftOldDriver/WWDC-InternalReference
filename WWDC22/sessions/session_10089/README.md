...
以上代码创建了一个 PDFView，设置了文档居中，并且背景颜色是灰色的；最特别的是，只要设置了`pdfView.allowsDragging = true`后，我们就可以通过手动拖动 pdf 文件到视图范围内就可以加载文档了。
...
如果想详细了解更多关于 PDFKit 的基础知识，请查看第一章`介绍PDFKit`。
