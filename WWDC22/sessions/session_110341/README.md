...
在国内，各类 App 登录账号最常用的方式是依靠手机号码进行注册，这也导致信箱里充斥了各类验证码，不仅如此，只要你在购物平台买过东西，也会有很多商家不断地推送各类营销折扣信息给你，除此之外，日常生活中还会接收到包括不限于各类App平台的信息、生活水电、出行信息通知、运营商通知等等，全部都混杂到一个收件箱里面，让人眼花缭乱。这个时候，用户就会感叹一下，要是能自动将短信过滤筛选，自动分类就好了。
