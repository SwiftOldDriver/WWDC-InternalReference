...
Swift Playgrounds app 4.x 的“指南”部分使用了 Swift DocC 替换了原先基于 SwiftPlaygroundBookTemplate 工程进行二次开发 Playground 的方式，基本上可以认为 Playground 在 Swift DocC 基础上做了些二次封装的标签。
