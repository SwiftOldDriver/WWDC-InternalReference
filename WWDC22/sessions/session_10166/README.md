...
现在你应该已经了解了应用追踪透明化 App Tracking Transparency 的基本情况了。那么作为开发者，首先要明确什么是用户追踪，其次确认你负责的 App 是否需要，最后根据 App 的实际情况，如果确实需要用户追踪，就按官方的要求去获得用户的许可。除此之外，本文中也列举了苹果官方明令禁止的一些可能损害用户隐私权益的行为，希望开发者不要触碰红线。
