...
> BookClub是一个用来跟踪图书阅读进度的 app, 在WWDC20中多次出现，更多资料请参考：https://developer.apple.com/documentation/swiftui/fruta_building_a_feature-rich_app_with_swiftui
...
> 备注: 小编查阅了SwiftUI最新的API发现 Window Scene 目前只支持 macOS 平台。
