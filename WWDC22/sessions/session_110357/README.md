...
看到这里，我们再次体会到了「没有银弹」这一金律：正则这一复杂问题不可能通过简单的方法解决。不仅如此，Swift Regex 目前还处于 Beta 阶段，只适配了最新的系统版本。但就像 Swift 一样，我们虽然进程缓慢但一直步伐坚定，因为我们一直不吝啬于花足够多的时间来探寻正确的方向，因为我们想要做的是解决问题而不是引入更多的新问题。
