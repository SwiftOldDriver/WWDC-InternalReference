...
先做个简单的科普，CarPlay 是苹果推出的车机交互系统，可以让你在汽车的中控屏中使用你的手机 App 能力，因为苹果对于应用要求的限制，所以现有的功能大部分是导航以及音乐、FM类的。
...
除此之外为了更方便大家理解对应的内容，也介绍了下 CarPlay 的 UI 绘制方式模板(Templates) 和一些设计原则。

鉴于此，我们先介绍下模板是什么东西，然后再展开关于新特性的介绍和吐槽。

## 模板

![image-20220628204507000](/Users/lucca/WWDC22/sessions/session_10016/images/image-20220628204507000.png)
...
![image-20220628204536511](/Users/lucca/WWDC22/sessions/session_10016/images/image-20220628204536511.png)

![image-20220628204605566](/Users/lucca/WWDC22/sessions/session_10016/images/image-20220628204605566.png)
...
![image-20220628204707158](/Users/lucca/WWDC22/sessions/session_10016/images/image-20220628204707158.png)
...
![image-20220628204735308](/Users/lucca/WWDC22/sessions/session_10016/images/image-20220628204735308.png)
...
![image-20220628204900372](/Users/lucca/WWDC22/sessions/session_10016/images/image-20220628204900372.png)

基于 `CPGridTemplate` 构建，很简单的里程记录器，可记录商务出行和个人出行。

![image-20220628204922977](/Users/lucca/WWDC22/sessions/session_10016/images/image-20220628204922977.png)

基于 `CPGridTemplate` 构建，高速路收费转发器，选择有几个乘客，这里不是很懂，应该是美国那边的高速按人收费的？

![image-20220628204942607](/Users/lucca/WWDC22/sessions/session_10016/images/image-20220628204942607.png)
...
![image-20220628205009908](/Users/lucca/WWDC22/sessions/session_10016/images/image-20220628205009908.png)
...
![image-20220628205142132](/Users/lucca/WWDC22/sessions/session_10016/images/image-20220628205142132.png)

打开模拟器，可以看到上面有很多按钮，除一些比较简单的功能，像是语音识别、电话模拟、浅/暗色主题切换、断开连接模拟。他还支持了模拟很多车都有旋钮操作(图中的上下左右功能），以及接下来重点阐述的高级配置功能。

![image-20220628205229808](/Users/lucca/WWDC22/sessions/session_10016/images/image-20220628205229808.png)

可以设置 CarPlay 屏幕的大小和方向盘位置。

![image-20220628205437901](/Users/lucca/WWDC22/sessions/session_10016/images/image-20220628205437901.png)

设置仪表盘的大小和安全显示区域。

![image-20220628205251488](/Users/lucca/WWDC22/sessions/session_10016/images/image-20220628205251488.png)
