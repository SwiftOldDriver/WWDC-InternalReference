...
人像画面在直播、视频会议等业务都有不错的运用场景；但画面的质量受限于摄像头本身，在没有特殊需求下，我们往往使用的就是设备内置或一般的网络相机。在 WWDC22 Session 10018 中，Apple 推出了 Continuity Camera（连续互通相机）-- 将 iPhone 与 Mac 连接后，iPhone 的后置摄像头会作为外设被 Mac 使用，向用户提供了一个高质量的智能摄像头。
...
从下面的数据上看，不难发现，笔记本相机的质量远不及手机的后置摄像头：

- Microsoft Surface Laptop Studio: 1080p 前置摄像头
- iMac 24: 1080p FaceTime 高清摄像头
- iPhone SE: 1200 万像素广角、最高可达 5 倍数码变焦、各种特效

结合来看，对于一个拥有新款 iPhone 的用户，除非去购买昂贵的高质量网络摄像头，否则很难在 Mac 上获得超过连续互通相机的人像换面体验--且不提连续互通相机并不需要额外的花费。

#### 本来就难以触达的 iPhone 后摄

那么，在一开始就使用 iPhone 的后置摄像头不久好了吗！但很遗憾这是非常困难的：
...
而无论使用哪种方法，都无法直接和视频会议等其他软件结合，仅能从理论上达到连续互通相机的能力了；且不说连续互通相机不仅仅只是提供了相机硬件而已。
...
Desk View：借助超广角镜头捕捉展示相机前下方的内容，类似高架机位。
