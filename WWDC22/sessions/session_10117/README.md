...
● 维护“channel”生命周期
iOS 16 系统增加了对“channel”生命周期的维护，通过 PushToTalk.framework 提供的 join、leave 接口我们可以加入和离开会议“channel”， 当我们成功进入或离开“channel”时， 系统都会更新当前 channel 的状态，同时将系统UI与channel的状态关联：
...
● 此时 iPhone用户B在后台，收到 APNs 的通知，见图中流程7；
