...
- [3. Safari 插件发展历程](#3-safari-插件发展历程)
  ...
  - [3.5. WWDC 2022 Safari Web Extension Manifest V3](#35-wwdc-2022-safari-web-extension-manifest-v3)
    - [3.5.1. Manifest V3](#351-manifest-v3)
    - [3.5.2. Declarative net request](#352-declarative-net-request)
    - [3.5.3. externally\_connectable](#353-externally_connectable)
    - [3.5.4. unlimited\_storage](#354-unlimited_storage)
    - [3.5.5. 同步插件](#355-同步插件)
