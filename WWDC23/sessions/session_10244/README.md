...
这里首先使用 Xcode 15 中打开该软件包，通过 `Build for Documentation` 选项我们可以评估当前的文档状态。
...
> 相关的社区提案原文
>
> [Document Extensions to External Types Using DocC](https://forums.swift.org/t/document-extensions-to-external-types-using-docc/56060)
>
...
对于问题 1 和问题 2，我们使用 `Metadata` 指令来自定义改页面的元数据，其中包括页面的类型、页面行动和页面图片。
