...
有关选择器新功能的深入说明，请观看《 [Embed the Photos Picker in your app](https://xiaozhuanlan.com/topic/5964728310) 》。
...
// 读取
let decryptedString = myRecord.encryptedValuess["encryptedStringField"] as? String
```
...
以上就是本届 WWDC 苹果在隐私方向所做出的更新。苹果这些年在隐私保护上的投入可谓是不遗余力，苹果在 2019 的 WWDC 上向开发者展示了苹果自己的[隐私设计理念](https://developer.apple.com/videos/play/wwdc2019/708)，并提出隐私是一项基本的人权，在自家产品进行设计研发阶段苹果会将这些隐私设计理念融入其中，因此苹果也希望苹果生态内的开发者也能将这些理念融入到自己的产品中去，大家一起努力构建一个能够尊重和保护用户隐私的生态体系。

紧接着在 2020 年的 WWDC ，苹果推出来一系列措施（参考文章 [Build trust through better privacy](https://xiaozhuanlan.com/topic/3628597401) ）确保隐私保护理念能被开发者贯彻实行，比如剪贴板读取警告、麦克风和摄像头打开提醒、商店隐私标签以及著名的用户追踪确认弹窗等措施，这一年可谓是隐私大年，新系统无情地曝光了一些厂商的滥用行为，在各路媒体铺天盖地地报道下，隐私保护的理念开始深入人心。

而在接下来的 2021 年和 2022 年（参考 [聚焦苹果隐私原则](https://xiaozhuanlan.com/topic/6921584730) 和 [What’s new in Privacy](https://xiaozhuanlan.com/topic/9482017536) ），苹果一鼓作气推出了隐私报告、隐私中继以及代替验证码和密码的 PAT 和 PassKey 等功能。同样也是在这两年苹果大刀阔斧的“隐私改革”也招来了一些抱怨，比如频繁的弹窗影响用户体验，因此作为回应苹果推出了一些隐私 UI 组件，使用这类组件采集用户隐私数据时，可以避免出现弹窗，其设计理念就是将控制权交还给用户，让用户对隐私数据访问的可感和可控。

苹果为了达到隐私保护的目标，一直围绕着数据最小化、本机处理、透明可控以及安全保护四个方面对产品和服务进行设计和优化。这些措施的背后自然有其商业目的，构建可信任的苹果生态、提高品牌的声誉等，但是互联网商业公司出于自身利益的考量，让其全盘接受苹果的这套隐私设计理念，恐怕不太现实。对于互联网公司来讲，构建隐私导向的产品，有些时候不仅仅是技术问题，更多的还要考虑成本和利润问题。因此除了依靠系统厂商的一些措施迫使厂商优化其产品，还需要出台相应的法律法规和更严格的监管手段。而我们作为开发人员，在参与产品设计和研发的过程中，也要时刻将用户隐私放在心上。只有在多方共同努力的基础上，才能构建出让用户信任的互联网生态。
