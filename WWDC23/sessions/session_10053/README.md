...
而在接下来的 2021 年和 2022 年（参考 [聚焦苹果隐私原则](https://xiaozhuanlan.com/topic/6921584730) 和 [What’s new in Privacy](https://xiaozhuanlan.com/topic/9482017536) ），苹果一鼓作气推出了隐私报告、隐私中继以及代替验证码和密码的 PAT 和 PassKey 等功能。同样也是在这两年苹果大刀阔斧的“隐私改革”也招来了一些抱怨，比如频繁的弹窗影响用户体验，因此作为回应苹果推出了一些隐私UI组件，使用这类组件采集用户隐私数据时，可以避免出现弹窗，其设计理念就是将控制权交还给用户，让用户对隐私数据访问的可感和可控。
