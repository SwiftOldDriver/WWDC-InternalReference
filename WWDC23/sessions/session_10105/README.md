...
![](https://p.ipic.vip/xxhjnx.png)
注意：并不是所有的场景都支持快门零延迟：
![](https://p.ipic.vip/9v8t7f.png)
...
前面我们提到过旧版本照片不处理完成，哪怕重复调用拍摄 API，也不会生效，为了保证更好的用户体验，iOS 17 给我们提供了监听拍摄状态的 API，便于我们管理按钮的状态
![](https://p.ipic.vip/5ie15w.png)
