...
本次 WWDC23 上 App Store Server API 虽然没有重大的变动更新，但是一些像 Get Transaction Info、Notifications status 接口的更新，开源库 App Store Server Library 的发布，都围绕着在简化我们处理应用内购买的目的进行优化，着力引导开发者迁移到新的 API，以下对新特性进行回顾
