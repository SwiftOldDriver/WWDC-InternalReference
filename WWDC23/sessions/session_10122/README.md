...
本文是根据 [Explore media formats for the web](https://developer.apple.com/videos/play/wwdc2023/10122/) 进行撰写，旨在探索现代的图片和视频格式以及他们在Web中的应用。
...
多年以来，广泛使用三种图像格式：GIF、JPEG 和 PNG，这些图像格式被所有浏览器支持。但是，随着技术的不断进步，出现了新的更出色的图像格式，这些技术能够提供更好的视觉体验。
...
JPEG-XL、AVIF 和 HEIC 的一个关键优势是它们都支持广色域和 HDR。大色域允许在文件上保留更多颜色并在屏幕上呈现更多颜色，HDR 可以更好地定义黑暗的深度、亮度的强度以及可接受的光线量。这样，你可以获得更多户外景观的活力，或者是具有大量对比度的非常明亮的场景，或者是完美呈现那些美丽而复杂的肤色。
