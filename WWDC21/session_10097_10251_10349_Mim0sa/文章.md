...
![](https://images.xiaozhuanlan.com/photo/2021/f4e27b2dfb9685479344c4f426f274cd.png)
...
![](https://images.xiaozhuanlan.com/photo/2021/9d5f4b6f4d85a3ef2620bea8378756be.jpeg)
...
在开始介绍如何使用 SF Symbols 之前，我们可以先下载来自 Apple 官方提供的 SF Symbols 3 App，这款 App 中收录了所有的 SF Symbols，并且记录了每个符号的名称，支持的渲染模式，不同语言的变体，不同 OS 版本下可能出现的不同的名称等相关信息，并且可以实时预览不同渲染模式下不同强调色的不同效果。你可以在[这里](https://developer.apple.com/sf-symbols/)下载 SF Symbols 3 App。

![](https://images.xiaozhuanlan.com/photo/2021/4365b76ee71586602606f3501fbc6009.png)

### 符号的渲染模式

通过之前的图片你可能已经注意到了，SF Symbols 可以拥有多种颜色，有一些 symbol 甚至还有预设的颜色，例如代表天气、肺部、电池的符号。如果要使用这些带有自定义颜色的符号，你需要了解，SF Symbols 有四种渲染模式：
...
![](https://images.xiaozhuanlan.com/photo/2021/4f67f707522ae7278fea77861ec99f2c.png)
...
![](https://images.xiaozhuanlan.com/photo/2021/0244164f563eb096f5ab82ebdcded51f.png)
...
![](https://images.xiaozhuanlan.com/photo/2021/69a6f565f6c6584ad26c126cc4bde07c.png)
...
![](https://images.xiaozhuanlan.com/photo/2021/73c0bbe29689155fc6e5bef05203e83e.png)
...
![](https://images.xiaozhuanlan.com/photo/2021/215ea0fabf3a7c449fa567b90c99c48a.png)
...
![](https://images.xiaozhuanlan.com/photo/2021/a3c3dbe9ff5d12ff9b3d1e16f867ffab.png)

### 符号变体

对于某些符号来说，有多种表现形式，我们以 `"heart"` 这个符号为例子，他有许多种变体：

![](https://images.xiaozhuanlan.com/photo/2021/3c9967f6d63acbfb1c082681728d511d.png)
...
在不同的使用场景下我们通常会使用不同风格的符号，比如 iOS 在 tab bar 中我们会使用填充样式（`.fill`）的符号，而 macOS 在 tab bar 中我们更倾向于线性符号。现在如果你是在 SwiftUI 中，在系统提供的大部分 View 中使用符号的话，你无需使用填充样式，系统会根据自身平台是 iOS 还是 macOS 来决定到底展示哪种风格的符号。以下方 SwiftUI 代码为例子，该 TabView 在 iOS 下是填充样式，而在 macOS 下是线性样式。
...
![](https://images.xiaozhuanlan.com/photo/2021/918b36555f3bbc0f222883bbb2306d29.png)

#### 在 Interface Builder 中使用符号

在代码中对 SF Symbols 进行配置的这些代码，在 Interface Builder 中也可以实现🎉。

![](https://images.xiaozhuanlan.com/photo/2021/d86c536995299e1d296515093d1afa79.png)
