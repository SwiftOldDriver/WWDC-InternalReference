# 【WWDC21 10232/10283】Shortcuts 的新功能

> 作者：saitjr，目前就职于字节跳动客户端平台架构，负责研发效率相关工作。
>
> 审核：mario, 目前就职于 RingCentral，负责视频会议业务。
...
![img](https://images.xiaozhuanlan.com/photo/2021/600ee4a241637e72583f06fe73e6e54a.jpg)

Shortcuts Editor 页面：

![img](https://images.xiaozhuanlan.com/photo/2021/7643dc0fae98ca721cf1c844e154307f.jpg)
...
![img](https://images.xiaozhuanlan.com/photo/2021/56d7009c1cc7a5135d3ef15d362a5758.jpg)
...
![img](https://images.xiaozhuanlan.com/photo/2021/347d9a983fdb5694eeba35ec9c9e6787.jpg)

### 对 Automator 与 Script 的兼容

Shortcuts Editor 内置了 Script 编辑器，可以直接调试和运行脚本。

![img](https://images.xiaozhuanlan.com/photo/2021/4d5949d50c3b3c21b15c49317d625cec.jpg)
...
![img](https://images.xiaozhuanlan.com/photo/2021/837caa9bc6e165b9ca3d6faf04da05c4.jpg)

迁移过后的 UI 风格也基本一致，非常友好：

![img](https://images.xiaozhuanlan.com/photo/2021/63591c69f17c9018b0098b9282385984.jpg)
...
![img](https://images.xiaozhuanlan.com/photo/2021/4bd5d9224580f2f78efb4b7248abd796.jpg)
...
![img](https://images.xiaozhuanlan.com/photo/2021/6a8edd319af3a4e5c5a03f2a70838bdf.jpg)
...
![img](https://images.xiaozhuanlan.com/photo/2021/c97899a8f9d7a3544f4f4cbfb1702178.jpg)
...
![img](https://images.xiaozhuanlan.com/photo/2021/dfd60f14b7d2d4131409df85804d2b68.jpg)

Types 定义完成后，接着需要创建可以提供的能力。比如，新增任务、删除任务、查看任务等。以下以新增任务为例，Intent 就像一个函数定义，包含名称和参数列表：

![img](https://images.xiaozhuanlan.com/photo/2021/7f94a7bdb68d74ee3d15870cc4115299.jpg)
...
![img](https://images.xiaozhuanlan.com/photo/2021/381dee0eaa65a517a96be35e8def221a.jpg)
...
![img](https://images.xiaozhuanlan.com/photo/2021/a46121f84105343765ef640d63f52384.jpg)

Shortcuts app 已经可以搜索到你的 Intent 了：

![img](https://images.xiaozhuanlan.com/photo/2021/a441280c1fce0d79c535a0552eef28bb.jpg)
...
![img](https://images.xiaozhuanlan.com/photo/2021/0a2cea73aaa76ccd6b92b736c4b56c94.jpg)
...
![](https://images.xiaozhuanlan.com/photo/2021/ecd7f985b78acc4939d7e9023c716fb8.png)
...
![img](https://images.xiaozhuanlan.com/photo/2021/d7e272ba23bc1e0eca2ec2f2b6a8b163.jpg)
...
![img](https://images.xiaozhuanlan.com/photo/2021/7cca62680119b068ff5340fedcd0db06.jpg)

对于 `dueDate` 来说，除了不能为空以外，还需要指定时间必须是未来时间。对此，需要新建一个自定义 error 来提醒用户。回到 _Intents.intentdefinition_ 文件，给 `dueDate` 参数新增错误类型：

![img](https://images.xiaozhuanlan.com/photo/2021/0172ee793941f4ce6f2ad95585e1a7fe.jpg)

然后在 resolve 方法中，就可以判断 `dueDate`，然后返回指定错误了：

![img](https://images.xiaozhuanlan.com/photo/2021/482cb282f04ceb0a5d880350e5767434.jpg)
...
![img](https://images.xiaozhuanlan.com/photo/2021/65ae5209d872eaa892f00cdeeae01455.jpg)

在实例化 `response` 后，需要给 `response` 新增要输出的属性。在本例中，`response` 需要输出一个任务对象：

![img](https://images.xiaozhuanlan.com/photo/2021/c02501dd58d9dbf03648a06e35f26edd.jpg)

然后再回到代码中，将创建的 `task` 赋值给 `response.task`：

![img](https://images.xiaozhuanlan.com/photo/2021/9de9603e154e9fdf517560d0ba44c399.jpg)

到此，就完成了 Intent 的创建和处理。最重要也是最容易忽视的一步：测试，记得尽量覆盖所有的用户场景 😜。测试可以在 Shortcuts app 中进行，比如用户可能输入一个不合法的 `dueDate`：

![img](https://images.xiaozhuanlan.com/photo/2021/26713504e268ec093ba67a6bb08d289e.jpg)
...
![img](https://images.xiaozhuanlan.com/photo/2021/122d7c5100b78812c0b780eb241b59f6.jpg)

对于版本升级的 App 也是如此。在 iOS 15 中，只要是相同开发者，同名 intents 也会自动进行迁移。

![img](https://images.xiaozhuanlan.com/photo/2021/abcbb9d9abac09710160c1098dc7ce4a.jpg)
...
![img](https://images.xiaozhuanlan.com/photo/2021/4536b76d75264949636c43a8459a88d1.jpg)

在 Swift/Objective-C app 中的访问方式（利用 Scripting Bridge）：

![img](https://images.xiaozhuanlan.com/photo/2021/42369f57e557b6ed433574a8d0b98db4.jpg)
...
![img](https://images.xiaozhuanlan.com/photo/2021/a2836d7a398360e0059a8f2b97a4a04d.jpg)

命令行中访问 shortcuts 的方式：

![img](https://images.xiaozhuanlan.com/photo/2021/1acbbb501b63fc1b2da6bef0aae5d7e3.jpg)
...
![img](https://images.xiaozhuanlan.com/photo/2021/b6678533623b9db41f2b045902954da1.jpg)

用户可以直接利用一个 action 生成 shortcuts，也可以将多个 action 进行组合，甚至还可以跨 app 进行组合。

![img](https://images.xiaozhuanlan.com/photo/2021/a3b76c23c27141d0d8d4f36811d0b2f6.jpg)

![img](https://images.xiaozhuanlan.com/photo/2021/890bf2c1ebee9f5fd4f500af3b488619.jpg)
...
![img](https://images.xiaozhuanlan.com/photo/2021/753e3900f930b6f9524553937cc3af17.jpg)
...
![img](https://images.xiaozhuanlan.com/photo/2021/d6d45fc9ff43b928e36a4fccb10bd7f6.jpg)
...
![img](https://images.xiaozhuanlan.com/photo/2021/cafe5b6aa9f4246736c2905e2ff8dac3.jpg)
...
![img](https://images.xiaozhuanlan.com/photo/2021/45a9377830b2eb3ed665cd350a725de4.jpg)
...
![img](https://images.xiaozhuanlan.com/photo/2021/171cafc3fbd7f92ea932d62eb8235d1d.jpg)
...
![img](https://images.xiaozhuanlan.com/photo/2021/2dd4c6e0cd5e8f6a17cf755da6596277.jpg)
...
![img](https://images.xiaozhuanlan.com/photo/2021/106bf8814cc36ae5c90cdd417a94c7cd.jpg)
...
![img](https://images.xiaozhuanlan.com/photo/2021/6455bfec0fbf77dd344a2e468377741f.jpg)

当我们引入其他 app 的 action 时，Shortcats 的模块化设计优势将更加明显。用户可以任意组合多个 app 的 action，这无疑是用户创造力的体现。

![img](https://images.xiaozhuanlan.com/photo/2021/97eb9263999a813a2c56308cda89b5db.jpg)
...
![img](https://images.xiaozhuanlan.com/photo/2021/e3b4968311cd1ec02aeddbff7b722241.jpg)

如果对输出类型进行拆分和标记，还可以在 Shortcuts Editor 编辑变量的时候找到他们：

![img](https://images.xiaozhuanlan.com/photo/2021/1dac6a413788aae8e6b7793f5bafe09f.jpg)
...
![img](https://images.xiaozhuanlan.com/photo/2021/89c17e084c9debf0fe06e5e5fc701afc.jpg)
...
![img](https://images.xiaozhuanlan.com/photo/2021/3f70a49060c411f01e33639c6db8ee47.jpg)
...
![img](https://images.xiaozhuanlan.com/photo/2021/d6db0ead4368159b95d0d970e8a7e8fc.jpg)
...
![img](https://images.xiaozhuanlan.com/photo/2021/209841644ef07ea80d43188d8c3562b6.jpg)
...
![img](https://images.xiaozhuanlan.com/photo/2021/f5a47e72819590a83f4e6f7e770ef40a.jpg)
...
![img](https://images.xiaozhuanlan.com/photo/2021/c4d6cf0cd4e756712495bbc564076a24.jpg)
...
![img](https://images.xiaozhuanlan.com/photo/2021/172199f0eb6ebe6e2ed57eb526a0cb31.jpg)

如果用户选择添加到 Siri，会告知用户应该以什么语句唤醒 shortcuts。当然，这个前提是 action 提供了 suggested invocation phrase。如果未提供，会让用户自己输入唤醒语句。

![img](https://images.xiaozhuanlan.com/photo/2021/a7699286ab301bd351e353227f7473ee.jpg)

以上，就是关于 Shortcuts 设计的全部内容，让我们最后再回顾一下好的 action 应具备的能力：

![img](https://images.xiaozhuanlan.com/photo/2021/ccdc2111e31c1136b1490fb4891bd98b.jpg)
