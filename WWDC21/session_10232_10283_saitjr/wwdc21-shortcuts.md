...
> 校对注（Mario1in）：
>
> 在这之前，其实 Shortcuts 一直都是一个不温不火的 topic，但其实从这里还是能看出苹果可能在下的一盘大棋。
>
> 在《未来简史》这本书中，有提到过未来的一大趋势，就是高度自动化。我们回头来看 Shortcuts 干的事情，一是将解决用户痛点的 task 由原来的界面操作，变成了输入 input，就输出 output；二是解决了不需要在多个 app 之间来回切换的情况下，实现了利用多个 app 来完成一系列需求的操作。
>
> 这两件事情的意义在于什么呢？可能现在看来，用 Shortcuts 干一件事，还不如我直接打开 app 操作来的快。这是因为目前人机交互的输入，主要还是靠手。然而当下一时代的智能设备到来的时候(比如 Apple Glass 什么的)，用户跟设备的人机交互就会发生巨大的转变，在那个时候，Shortcuts 或许就能发挥出巨大的作用了。
...
![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2008.57.17.jpg)
...
![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2008.57.26.jpg)

### 对 Automator 与 Script 的兼容

Shortcuts Editor 内置了 Script 编辑器，可以直接调试和运行脚本。

![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2008.57.37.jpg)
...
![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2008.57.55.jpg)

迁移过后的 UI 风格也基本一致，非常友好：

![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2008.58.13.jpg)
...
![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2008.58.23.jpg)
...
![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2008.58.34.jpg)
...
![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2008.58.45.jpg)
...
![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2008.59.04.jpg)

Types 定义完成后，接着需要创建可以提供的能力。比如，新增任务、删除任务、查看任务等。以下以新增任务为例，Intent 就像一个函数定义，包含名称和参数列表：

![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2008.59.16.jpg)
...
![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2008.59.29.jpg)
...
![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2008.59.49.jpg)

Shortcuts app 已经可以搜索到你的 Intent 了：

![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.00.16.jpg)
...
![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.00.30.jpg)

在实现相关方法后，我们在 App Target 中，关联这个 app 所支持的 Intents：

![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.00.53.jpg)
...
![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.01.07.jpg)
...
![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.01.20.jpg)
...
![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.01.30.jpg)

对于 `dueDate` 来说，除了不能为空以外，还需要指定时间必须是未来时间。对此，需要新建一个自定义 error 来提醒用户。回到 _Intents.intentdefinition_ 文件，给 `dueDate` 参数新增错误类型：

![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.01.43.jpg)

然后在 resolve 方法中，就可以判断 `dueDate`，然后返回指定错误了：

![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.01.55.jpg)
...
![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.02.06.jpg)

在实例化 `response` 后，需要给 `response` 新增要输出的属性。在本例中，`response` 需要输出一个任务对象：

![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.02.24.jpg)

然后再回到代码中，将创建的 `task` 赋值给 `response.task`：

![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.02.35.jpg)

到此，就完成了 Intent 的创建和处理。最重要也是最容易忽视的一步：测试，记得尽量覆盖所有的用户场景 😜。测试可以在 Shortcuts app 中进行，比如用户可能输入一个不合法的 `dueDate`：

![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.02.46.jpg)
...
![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.02.58.jpg)

对于版本升级的 App 也是如此。在 iOS 15 中，只要是相同开发者，同名 intents 也会自动进行迁移。

![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.03.08.jpg)
...
![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.03.19.jpg)

在 Swift/Objective-C app 中的访问方式（利用 Scripting Bridge）：

![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.03.29.jpg)
...
![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.03.40.jpg)

命令行中访问 shortcuts 的方式：

![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.03.48.jpg)
...
![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.04.00.jpg)

用户可以直接利用一个 action 生成 shortcuts，也可以将多个 action 进行组合，甚至还可以跨 app 进行组合。

![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.04.14.jpg)

![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.04.26.jpg)
...
![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.04.43.jpg)
...
![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.04.53.jpg)
...
![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.05.04.jpg)
...
![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.05.31.jpg)
...
![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.05.43.jpg)
...
![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.05.54.jpg)
...
![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.06.03.jpg)
...
![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.06.17.jpg)

当我们引入其他 app 的 action 时，Shortcats 的模块化设计优势将更加明显。用户可以任意组合多个 app 的 action，这无疑是用户创造力的体现。

![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.06.28.jpg)
...
![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.06.40.jpg)

如果对输出类型进行拆分和标记，还可以在 Shortcuts Editor 编辑变量的时候找到他们：

![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.06.54.jpg)
...
![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.07.04.jpg)
...
![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.07.27.jpg)
...
![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.07.39.jpg)
...
![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.07.49.jpg)
...
![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.08.11.jpg)
...
![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.08.21.jpg)
...
![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.08.33.jpg)
...
![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.08.44.jpg)

如果用户选择添加到 Siri，会告知用户应该以什么语句唤醒 shortcuts。当然，这个前提是 action 提供了 suggested invocation phrase。如果未提供，会让用户自己输入唤醒语句。

![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.08.55.jpg)

以上，就是关于 Shortcuts 设计的全部内容，让我们最后再回顾一下好的 action 应具备的能力：

![img](https://gitee.com/tangjr/public-resources/raw/master/wwdc2021/shortcuts/iShot2021-06-28%2009.09.07.jpg)
