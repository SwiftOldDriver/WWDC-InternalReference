...
>
> 这两件事情的意义在于什么呢？可能现在看来，用 Shortcuts 干一件事，还不如我直接打开 app 操作来的快。这是因为目前人机交互的输入，主要还是靠人类最灵活的双手。然而这双手承载了我们生活中太多的职责，下一时代的智能设备，必然是可以解放双手的（例如万众期待的Apple Glass），用户与设备的交互，必然也会发生巨大的转变，在那个时候，受限于输入方式，Shortcuts 或许就能发挥出巨大的作用了。
