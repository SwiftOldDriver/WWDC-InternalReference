...
![sheet](https://images.xiaozhuanlan.com/photo/2021/3abc9fc06752b39ca1ca0e15632cea1f.png)
...
![fullscreen_lifecycle](https://images.xiaozhuanlan.com/photo/2021/bfd93110a77766d9fefb23d2259f251c.png)
如下是 `modalPresentationStyle` 为 `UIModalPresentationPageSheet` 或`UIModalPresentationFormSheet` 时，两者的生命周期方法的调用情况。
![sheet_lifecycle](https://images.xiaozhuanlan.com/photo/2021/8889fba2957b35b949b65f14faa681c8.png)
...
![presentation_lifecycle](https://images.xiaozhuanlan.com/photo/2021/d27cc48af2051313aff82dbc6a1d340c.png)
### 拖拽手势
...
![modalInPresentation](https://images.xiaozhuanlan.com/photo/2021/a3ac81360cac7137eff531ed62cfab16.png)
...
![sheet_horizontal](https://images.xiaozhuanlan.com/photo/2021/cb16da5465ca82bf6c7ca1e991725646.png)
...
![](https://images.xiaozhuanlan.com/photo/2021/1942f64c9b390f021c99132444651c09.png)

![resize](https://images.xiaozhuanlan.com/photo/2021/4006a9261d70d9c197be542932c28846.gif)
...
![](https://images.xiaozhuanlan.com/photo/2021/e6648a7ade9727d50dd49e2327f4fa68.png)
...
![grabber](https://images.xiaozhuanlan.com/photo/2021/67f26d16d531c0d15c89faf9ca38d4af.png)
...
```
![detent_select](https://images.xiaozhuanlan.com/photo/2021/bd0ee5d113f8ac0e3aea36738ffe42ed.gif)
...
> 在 `Xcode 13`  实际装载的 `iOS 15 SDK` 中，`smallestUndimmedDetentIdentifier` 被修改为 `largestUndimmedDetentIdentifier`，但其行为仍然和上述表述保持一致。
...
![popover](https://images.xiaozhuanlan.com/photo/2021/f36ba504ea7a19cfbefef83873308aff.gif)

为了达到此目的，我们只需要对之前的代码进行很少的修改：
![](https://images.xiaozhuanlan.com/photo/2021/7173d076388c78ad09a138be1e447fa7.png)
可见，为了适配 iPad，我们需要:
