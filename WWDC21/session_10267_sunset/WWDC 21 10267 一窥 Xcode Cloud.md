...
一个典型的持续集成工作流程如下图所示：
![](https://images.xiaozhuanlan.com/photo/2021/a0dce11643965f47127fa562e280ab55.jpeg)
1. 将发生变动的代码推送至远端代码仓库。
2. 项目开始构建、运行测试代码和其他自定义步骤。
3. 如若通过质量测试（构建成功、测试通过等），保存构建产物，并发出通知至其他团队成员。

再让我们看一下 iOS 应用常见的开发流程：
![](https://images.xiaozhuanlan.com/photo/2021/e57956ac7f6be86280144625ef3995d8.jpeg)
1. 修复 Bug 和完成新的需求。
...
![](https://images.xiaozhuanlan.com/photo/2021/65d68049deeddaf36d2463509474ce1d.jpeg)
...
![](https://images.xiaozhuanlan.com/photo/2021/949d616f92cbba2aab32155d4d890c41.jpeg)
...
![](https://images.xiaozhuanlan.com/photo/2021/60fc2b31d20c8d29e84e2b50d987b26d.jpeg)

在左侧边栏中点选某个工作流，展现在我们面前的是该工作流单次运行的总览。从这里，我们能看到测试代码运行的结果与相应的日志，甚至可以双击报错处，直接定位到导致出错的某一行代码。

![](https://images.xiaozhuanlan.com/photo/2021/529c2cf03c2e7a70958e81c40baa49d4.jpeg)
...
## 为你的工程配置 Xcode Cloud
![](https://images.xiaozhuanlan.com/photo/2021/ce0070acd35f5d12ffc215edb6f79639.jpeg)

在 Xcode 13 中（满足一些前提条件之后）仅需几步操作即可为你的工程配置 Xcode Cloud。

![](https://images.xiaozhuanlan.com/photo/2021/95e0f50f69fd1c5509be81be2f97e860.jpeg)

接着，选中接入 Xcode Cloud 的应用（这里以 Fruta 为例）

![](https://images.xiaozhuanlan.com/photo/2021/ba07e7e46f40f9b46ec5f21f8d49b3cd.jpeg)
...
![](https://images.xiaozhuanlan.com/photo/2021/12e99fed9d91bfb9cc9da0d40ed2cde2.jpeg)

在 App Store Connect 上完成授权后就可以回到 Xcode 本地继续之前的流程。

![](https://images.xiaozhuanlan.com/photo/2021/51d9c86e610836086f6fd498acfd4056.jpeg)
点击 `Complete` 按钮，Xcode Cloud 将会帮助开发者把应用信息注册至 App Store Connect。

![](https://images.xiaozhuanlan.com/photo/2021/fd76423cfccb0dd5b8521ece64d4b008.jpeg)

终于到了最后一步！点击 `Start Build` 按钮，就可以开始第一次构建。

## 检阅 Xcode Cloud 构建报告

![](https://images.xiaozhuanlan.com/photo/2021/f16b3123955117350b3ab64b9fcc8d41.jpeg)

以 Fruta 这次构建为例：从该构建报告中，我们可以清晰明了地知道构建耗时以及构建环境的配置。点击右上角的 `Rebuild` 按钮也能帮助我们重新开始构建。

![](https://images.xiaozhuanlan.com/photo/2021/c1a44a0233569bd9af713afd4eace7d3.jpeg)
![](https://images.xiaozhuanlan.com/photo/2021/60a9a5aefe89c6636f8a1b0f021fa96c.jpeg)
在 `Actions` 一列中，点击单个 action，可以看到该次 Action 的日志和相应的产物。这样的设计使得整个团队都能很方便地获取到当前 CI 的信息。

![](https://images.xiaozhuanlan.com/photo/2021/e9491e055bc186bfb5bb9aa94a17e159.jpeg)

喔嚯，在 Build 1 中的「 在 macOS 上归档（Archive）」这一任务失败了！是因为无法在 macOS 上使用 UIKit 框架。我们可以把鼠标移至报错处，点击 ➡️ 小箭头，会直接跳转到对应出错的代码文件。

![](https://images.xiaozhuanlan.com/photo/2021/721086b18966dc74dfd1ad5513d6b8b5.jpeg)
根据之前的报错提示，我们可以快速定位问题。

![](https://images.xiaozhuanlan.com/photo/2021/20862e2308e236d084f149c078be9eee.jpeg)
...
![](https://images.xiaozhuanlan.com/photo/2021/d86f9b4cb858cf18f0311e9c9d28b0b2.jpeg)

将工作流的名称从 `Default` 修改为 `Releases` 更加符合该工作流的意图。

![](https://images.xiaozhuanlan.com/photo/2021/045f648bbde09400cd1cfffb56705acf.jpeg)

点选左侧边栏的 `Start Condition` 就可以开始编辑该工作流的触发条件。
类似地，我们在 `Custom Branches` 一栏中点击 + 号，添加 `release/v1` 分支。

![](https://images.xiaozhuanlan.com/photo/2021/75728638fc6e39175424064809090a98.jpeg)
