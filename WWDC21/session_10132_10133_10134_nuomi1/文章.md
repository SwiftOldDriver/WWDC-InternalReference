...
本文基于 Session [10132](https://developer.apple.com/videos/play/wwdc2021/10132/) / [10134](https://developer.apple.com/videos/play/wwdc2021/10134/) / [10133](https://developer.apple.com/videos/play/wwdc2021/10133/) 梳理，使用「获取缩略图」的例子对 Swift 5.5 新增的异步与并发编程进行讲解，如需了解更多，欢迎查看其它 Session。
...
我们用一段代码来看看 `async` 和 `await` 是怎么工作的，线程的变化又是怎样的:
...
func calculate() async -> Int {
    ...
    defer { print(#function, #line, Thread.current) }
...
func download() async -> Data? {
    ...
    let pair = try? await URLSession.shared.data(from: url!, delegate: nil)
...
func task() async {
    print(#function, #line, Thread.current)
    print(#function, #line, Thread.current, await calculate())
    print(#function, #line, Thread.current)
    print(#function, #line, Thread.current, await download()!)
    print(#function, #line, Thread.current)
}
...
```text
main() 30 <NSThread: 0x600003c68800>{number = 1, name = main}
main() 32 <NSThread: 0x600003c70380>{number = 4, name = (null)}
task() 22 <NSThread: 0x600003c70380>{number = 4, name = (null)}
calculate() 5 <NSThread: 0x600003c70380>{number = 4, name = (null)}
calculate() 6 <NSThread: 0x600003c70380>{number = 4, name = (null)}
task() 23 <NSThread: 0x600003c70380>{number = 4, name = (null)} 2
task() 24 <NSThread: 0x600003c70380>{number = 4, name = (null)}
download() 12 <NSThread: 0x600003c70380>{number = 4, name = (null)}
main() 36 <NSThread: 0x600003c68800>{number = 1, name = main}
download() 13 <NSThread: 0x600003c648c0>{number = 5, name = (null)}
task() 25 <NSThread: 0x600003c70380>{number = 4, name = (null)} 72886 bytes
task() 26 <NSThread: 0x600003c648c0>{number = 5, name = (null)}
main() 34 <NSThread: 0x600003c648c0>{number = 5, name = (null)}
```
