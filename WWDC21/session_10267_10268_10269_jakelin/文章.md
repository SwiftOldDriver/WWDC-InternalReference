...
### New Build System
谢谢 [红纸](https://github.com/nianran) 指出[参考链接](https://developer.apple.com/documentation/xcode/requirements-for-using-xcode-cloud)，要在已有项目上使用 Xcode Cloud，必须符合下面的要求。
