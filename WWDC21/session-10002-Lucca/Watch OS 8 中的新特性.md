...
![](https://images.xiaozhuanlan.com/photo/2021/ec35b96e472f758b6ba8655eb51c426c.png)
...
![](https://images.xiaozhuanlan.com/photo/2021/cd1a97f489642750065aa6d964ad90a6.png)

在常亮显示状态下，整体的亮度会变低。同时淡化了很多高亮颜色的显示，像是按钮的颜色，数字输入框的边框。让整体看起来不是特别的显眼。

![](https://images.xiaozhuanlan.com/photo/2021/dd18c887c26e70ee5799521570f0eed1.png)

在这个例子中，我们突出了操作相关的 UI，把次要的背景图隐藏了。

![](https://images.xiaozhuanlan.com/photo/2021/739f929380b5682540fa1fc9ebb59d46.png)
...
![](https://images.xiaozhuanlan.com/photo/2021/87a169a493836a7ac5fcaaf4565b1daf.png)
...
![](https://images.xiaozhuanlan.com/photo/2021/bea1a10d4a76f046a4ed256a07635069.png)
...
![](https://images.xiaozhuanlan.com/photo/2021/de04e2a7c6a5529230fd90ddbba06d7c.png)
...
![](https://images.xiaozhuanlan.com/photo/2021/b67aee1c827e8ff62e49ee80674104d1.png)
...
![](https://images.xiaozhuanlan.com/photo/2021/6c646cc5777238154212f583dda86e7a.png)
...
![](https://images.xiaozhuanlan.com/photo/2021/ff17ad75677f683a5e85a8dafb67a415.png)

App 一小时会收到一次结果，但如果用户将你的 App 当做复杂功能添加到活跃表盘的时候，你的 App 将会在一小时收到四次数据。这些数据刷新都会占用你 App 的后台刷新预算。

![](https://images.xiaozhuanlan.com/photo/2021/0d488185c645e61167b781e2efff9a95.png)
...
![](https://images.xiaozhuanlan.com/photo/2021/7f68da2c07ac518dd266af6d51dba861.png)

这是 Qardio ，通过连接用户的心电图检测设备来检测用户的心脏状态。

![](https://images.xiaozhuanlan.com/photo/2021/91c66fcf7d2f7f8f61cf50e44e2758b4.png)

当我们将 Qardio 添加到复杂功能时，他可以在后台连接到对应的蓝牙心电图设备，然后更新相应的心电图信息。与上文的健康数据后台刷新一样，该操作一小时只能触发四次，同时也会占用 App 的后台刷新预算。

## 基于地理位置的通知

![](https://images.xiaozhuanlan.com/photo/2021/646679a0a70725ebf8f91202c88fe553.png)
...
![](https://images.xiaozhuanlan.com/photo/2021/c374919e291b3c08c42943177959163e.png)

用户需要开启`When in use`的地理位置权限才会收到通知，一开始会收到一条预设好的本地通知，点击后才可以查看完整的动态通知。

并且用户可以限制只有到关注的几个地点时才接受通知，当区域半径设置为200m左右的时候，效率最高。

![](https://images.xiaozhuanlan.com/photo/2021/ea36f56e46eaf1c87fe772acab90406f.png)

Location 还提供了一个增强功能 `Location Button` ，让用户无需在获取单次地理位置的时候都要确认单次的地理位置授权弹窗，只需要点击此按钮，即可获取单次地理位置信息。

## 其他的功能增强

![](https://images.xiaozhuanlan.com/photo/2021/49bd29a34d577f23caa4eb0ec3f4e973.png)
...
![](https://images.xiaozhuanlan.com/photo/2021/c8cda8160e43302794f7ae33f3e2fc18.png)

6. 改进了文本输入

![](https://images.xiaozhuanlan.com/photo/2021/64b89b53b8912a63c5f3ead67e116939.png)
...
![](https://images.xiaozhuanlan.com/photo/2021/4e23df3a49ff0bb1a11c8a8ec85ede6e.gif)

## 功能实现

从上面的 GIF 图中可以看出这是一个很简单的 Watch 应用，他包含四个界面，其中一个音乐播放页是用`NowPlayingView`直接实现的，我们不做详细讲解

![](https://images.xiaozhuanlan.com/photo/2021/6981f1e847972812dd0c34a30b8c7a56.png)
...
![](https://images.xiaozhuanlan.com/photo/2021/e630eb7967a01e86b990188bfa3c2077.png)

从上图的模块功能图里可以看出，这个 App 的功能还是比较简单的。`WorkoutManager`承担了 Controller 和 Model 的作用，把各个视图之间的数据流转和页面切换(状态变更)串连起来。

![](https://images.xiaozhuanlan.com/photo/2021/f2283d62da77c84cf3c4636a24a73808.png)
