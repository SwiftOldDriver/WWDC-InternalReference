...
![10205-02-icode](https://cdn.nlark.com/yuque/0/2021/png/1315574/1625409013921-4290aac7-9bd8-4160-b8b9-bef5cf7bd49b.png?x-oss-process=image%2Fresize%2Cw_2088)
...
![10205-03-show-changes](https://cdn.nlark.com/yuque/0/2021/png/1315574/1624180040124-eaf48879-7bcd-497b-8db1-596f387627f0.png)

这样我们就可以点击在编辑栏中的 `Code Review` 按钮（双向箭头的 icon），进入 `Code Review` 模式：

![10205-04-code-review](https://cdn.nlark.com/yuque/0/2021/png/1315574/1624180371235-df80b0c9-2993-4b24-937c-b611a5bf5850.png)
...
![10205-05-all-changes](https://cdn.nlark.com/yuque/0/2021/png/1315574/1624181079994-ab6e3bf8-62d1-40b5-9e01-292773b9ed25.png)

这样，我们就不必滚动鼠标滚轮去找每一处改动了。

底部的工具栏中还有一个 `提交控制` 按钮，这样我们就可以方便对比不同版本间的文件改动了，我们可以选择同一或者不同分支的两个 `commit` 或者 `tag` 进行对比

![10205-06-compare](https://cdn.nlark.com/yuque/0/2021/png/1315574/1624181853575-2b091ebc-05a6-4c6c-94cf-ba0b996290b3.png)
...
![10205-07-comapre-and-reset](https://cdn.nlark.com/yuque/0/2021/png/1315574/1624182019729-3fa78682-6a5c-4d5b-b4ce-6aa77f15fd0d.png)
...
![10205-08-change-list](https://cdn.nlark.com/yuque/0/2021/png/1315574/1624182647804-ba6cf431-dfef-40a8-9d8a-5c3315d0269c.png)
...
![10205-09-branches](https://cdn.nlark.com/yuque/0/2021/png/1315574/1624183178609-3a31e924-41ed-49c9-8e5f-7f2585e7a00d.png)
...
![10205-10-pull-request](https://cdn.nlark.com/yuque/0/2021/png/1315574/1624184388118-f6eaef49-07c2-4d93-9fa1-c1f32ff27b75.png)
...
![10205-11-feedback](https://cdn.nlark.com/yuque/0/2021/png/1315574/1624184774156-99c3a109-1f5b-4623-8cf6-5b302763c9d3.png)

如果我们是用来 `Xcode Cloud` 的话，我们也能在这里看到相应的状态：

![10205-12-xcode-cloud](https://cdn.nlark.com/yuque/0/2021/png/1315574/1624185050113-418fbbf3-85e3-4085-9035-4d0d2f6ee074.png)，更多关于 `Xcode Cloud` 请移步 [session 10267 Meet Xcode Cloud](https://developer.apple.com/wwdc21/10267)，至此，我们已经完成了 `Code Review` 的步骤。下面我们就需要合并我们的代码了。
...
![10205-13-merge](https://cdn.nlark.com/yuque/0/2021/png/1315574/1624185568942-bb5fb36d-e965-410f-8afa-8e2cffe5d377.png)

至此，我们的 bug 已经 fix 完毕。日常开发中你也一定会担任 Code Reviewer 的角色，那么使用 `Xcode 13` 我们可以怎么 review 别的同学的代码呢？

## Review your peer's changes

![10205-14-cooperation](https://cdn.nlark.com/yuque/0/2021/png/1315574/1624185945473-ceefc66c-74e7-4925-87b0-fcef95cd3270.png)
...
![10205-15-comment](https://cdn.nlark.com/yuque/0/2021/png/1315574/1624186440147-074c6063-bfd9-407d-a9c5-90677a5c10cc.png)
