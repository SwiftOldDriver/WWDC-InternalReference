...
![session_10212_banner](session_10212_banner.png)
...
![instrument_13_whole](session_10212_images/wwdc-instrument-13-whole.png)
...
1. 最上层的 HTTP Tracffic 记录了你的 app 整个生命周期内有几个 URLSession tasks。
	...
	![instrument_13_top](session_10212_images/wwdc-instrument-13-top.png)
 
2. 次层以 Process 进程作为区别，在每个进程底下你可以看到都有几个 URLSession 进行著，你也可以看到 URLSession 做了哪些任务。

	![instrument_13_middle_1](session_10212_images/wwdc-instrument-13-middle1.png)

	![instrument_13_middle_2](session_10212_images/wwdc-instrument-13-middle2.png)
...
3. 最下层是以每个请求的 Domain 域名作为区隔，你可以看到每个请求的状态，包含它的请求方法，响应时间，成功或者失败等等。
	...
	![instrument_13_bottom](session_10212_images/wwdc-instrument-13-bottom.png)
...
比如：
	![transaction_success](session_10212_images/wwdc-transaction-success.png)
如果请求失败（自动带入错误信息，方便调适）：
	![transaction_failure](session_10212_images/wwdc-transaction-failure.png)
...
![multi_transactions](session_10212_images/wwdc-multi-transactions.png)
...
![transactions_labels](session_10212_images/wwdc-transaction-labels.jpeg)
...
![transactions_state](session_10212_images/wwdc-transaction-state.jpeg)
...
![transactions_state_of_GET](session_10212_images/wwdc-transaction-state-get.png)

## 如何检测你的网络请求并且解决问题

接下来我们藉由一个实际的 APP 操作，了解如何利用 HTTP Instrument 检测你的网络请求，并且了解如何修复问题及提升效能。

<div align=center/>![instrument-dogs-demo](session_10212_images/wwdc-instrument-dogs-demo.png)
...
![instrument_network_template](session_10212_images/wwdc-instrument-network.png)

我们选择 Network template，它会展示 APP 里所有的网络活动，也包含了这次新增加的 HTTP 追踪功能。

![instrument_network_tracks](session_10212_images/wwdc-instrument-tracks.png)
...
![instrument_track1](session_10212_images/wwdc-instrument-track1.png)

我们可以看到第一个任务是向服务端 GET 查询所有的图像列表，这些图像会出现在 APP 的 "Latest" Tab。

![instrument_track2](session_10212_images/wwdc-instrument-track2.png)

当这个任务完成后，我们会创建新的任务去载入列表上每张图像的缩略图以展示。

![instrument_track3](session_10212_images/wwdc-instrument-track3.png)

总的来说，我们大概需要超过七秒的时候，才能完成全部图像的加载

![instrument_track4](session_10212_images/wwdc-instrument-track4.png)
...
![instrument_track5](session_10212_images/wwdc-instrument-track5.png)

这个模式下只会展示所有的 transactions，而不是对每个任务分组。现在我们就可以知道这些请求被放在哪些连接中。

![instrument_track6](session_10212_images/wwdc-instrument-track6.png)
...
![instrument_track7](session_10212_images/wwdc-instrument-track7.png)
...
![instrument_track8](session_10212_images/wwdc-instrument-track8.png)
...
| ![instrument_track9](session_10212_images/wwdc-instrument-track9.png) | ![instrument_track10](session_10212_images/wwdc-instrument-track10.png) |
| :-----| ----: |
...
![instrument_track11](session_10212_images/wwdc-instrument-track11.png)
...
![instrument_track12](session_10212_images/wwdc-instrument-track12.png)
...
![instrument_track13](session_10212_images/wwdc-instrument-track13.png)
...
| ![instrument_track14](session_10212_images/wwdc-instrument-track14.png) | ![instrument_track15](session_10212_images/wwdc-instrument-track15.png) |
| :-----| ----: |
...
![instrument_track16](session_10212_images/wwdc-instrument-track16.png)

底下列表有很多请求，我可以用左下角的过滤器來搜索与 "Favorites" 相关的请求，这样我们就能验证是否发出了请求。

![instrument_track17](session_10212_images/wwdc-instrument-track17.png)

过滤后，结果显示我们发送了多个请求，让我们检查每个请求，并且关注在 track view 上面，假如请求时间很短暂的话，你可以放大检视。

![instrument_track18](session_10212_images/wwdc-instrument-track18.png)
...
![instrument_track18](session_10212_images/wwdc-instrument-track19.png)
...
| ![instrument_track20](session_10212_images/wwdc-instrument-track20.png) | ![instrument_track21](session_10212_images/wwdc-instrument-track21.png) |
| :-----| ----: |
...
![instrument_track22](session_10212_images/wwdc-instrument-track22.png)
...
![instrument_track23](session_10212_images/wwdc-instrument-track23.png)
...
![instrument_track24](session_10212_images/wwdc-instrument-track24.png)
...
| ![instrument_track25](session_10212_images/wwdc-instrument-track25.png) | ![instrument_track26](session_10212_images/wwdc-instrument-track26.png) |
| :-----| ----: |
