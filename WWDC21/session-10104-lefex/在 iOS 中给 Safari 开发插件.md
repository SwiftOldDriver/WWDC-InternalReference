...
![image-20210620220421973](/Users/suyanwang/Downloads/session-10104-lefex/images/image-20210620220421973.png)

完成上面的操作后，可以看到网页中鱼的名字被替换成了 emoji 表情，并且有个气泡提示总共有多少单词被替换了，这个气泡称为 pop-page ，后面会用到。当你点击链接，跳转到新的页面时，插件会一直工作，无需重新开启。是不是很 cool！

![image-20210620220923480](/Users/suyanwang/Downloads/session-10104-lefex/images/image-20210620220923480.png)

当打开一个新的空白页面时，会显示到目前为止总共发生了多少次替换，这个页面被称为 tab-page：

![image-20210620221415227](/Users/suyanwang/Downloads/session-10104-lefex/images/image-20210620221415227.png)



上面为大家演示了这个插件的主要功能，接下来我们看下如何把这个插件移植到 iOS 上。

即使你以前没有开发过浏览器插件也没关系，这节内容我会详细讲解浏览器插件的运行原理、开发流程、最佳佳实践和调试技巧，最后还会介绍一下浏览器插件中的用户隐私问题。有一点需要注意， 浏览器插件也是应用程序的一种，如果想使用浏览器插件，需要到 App Store 上下载，对于开发者来说，需要把你的浏览器插件上传到 app store 中。
...
![image-20210620230401562](/Users/suyanwang/Downloads/session-10104-lefex/images/image-20210620230401562.png)

下图是创建完后所有的资源文件：

![image-20210620230456996](/Users/suyanwang/Downloads/session-10104-lefex/images/image-20210620230456996.png)
...
![image-20210620231113255](/Users/suyanwang/Downloads/session-10104-lefex/images/image-20210620231113255.png)

**第三：把 mac 中的 Safari 插件兼容 iOS**

如果你已经创建过 mac 版的 Safari 插件，可以使用命令工具来兼容 iOS 版本：

![image-20210620231339849](/Users/suyanwang/Downloads/session-10104-lefex/images/image-20210620231339849.png)

我们一起把 Sea Creator 兼容 iOS，先执行命令：

![image-20210620231650466](/Users/suyanwang/Downloads/session-10104-lefex/images/image-20210620231650466.png)

当执行完命令后，会自动打开 Xcode，可以看到兼容 iOS 版本的插件代码：

![image-20210620232023248](/Users/suyanwang/Downloads/session-10104-lefex/images/image-20210620232023248.png)
...
![image-20210621084729666](/Users/suyanwang/Downloads/session-10104-lefex/images/image-20210621084729666.png)
...
![image-20210621085704657](/Users/suyanwang/Downloads/session-10104-lefex/images/image-20210621085704657.png)



我们看一看插件中所有的页面是否可以在 iOS 上正常显示，首先看下 tab-page 这个页面，发现字体有点小，这是因为这个页面以前只在 Mac 上运行，需要让这个页面兼容手机端。下面通过 Safari 调试这个页面。

![image-20210626162200525](/Users/suyanwang/Downloads/session-10104-lefex/images/image-20210626162200525.png)
...
![image-20210626204413246](/Users/suyanwang/Downloads/session-10104-lefex/images/image-20210626204413246.png)
...
![image-20210626161832891](/Users/suyanwang/Downloads/session-10104-lefex/images/image-20210626161832891.png)
...
![image-20210627171555763](/Users/suyanwang/Downloads/session-10104-lefex/images/image-20210627171555763.png)
...
![image-20210627172417891](/Users/suyanwang/Downloads/session-10104-lefex/images/image-20210627172417891.png)

在 ipad 上也可以打开多个 window：

![image-20210627172602074](/Users/suyanwang/Downloads/session-10104-lefex/images/image-20210627172602074.png)
...
![image-20210627172756213](/Users/suyanwang/Downloads/session-10104-lefex/images/image-20210627172756213.png)

下面这张图，调用  `broswser.windows.getAll()` 或获取到 4 各 window 对象：

![image-20210627173354559](/Users/suyanwang/Downloads/session-10104-lefex/images/image-20210627173354559.png)

在使用 window 上的一些 api 时，需要留意， 在 iOS 和 mac 中有很大区别，iOS 表现如下：

![image-20210626183110677](/Users/suyanwang/Downloads/session-10104-lefex/images/image-20210626183110677.png)
...
![image-20210626183351560](/Users/suyanwang/Downloads/session-10104-lefex/images/image-20210626183351560.png)
...
![image-20210626183618449](/Users/suyanwang/Downloads/session-10104-lefex/images/image-20210626183618449.png)
