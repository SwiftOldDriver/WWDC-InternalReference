...
![image-20210620220421973](https://images.xiaozhuanlan.com/photo/2021/1168878b3d030d6c9c4ccd1611e83d6e.png)

完成上面的操作后，可以看到网页中鱼的名字被替换成了 emoji 表情，并且有个气泡提示总共有多少单词被替换了，这个气泡称为 pop-page ，后面会用到。当你点击链接，跳转到新的页面时，插件会一直工作，无需重新开启。是不是很 cool！

![image-20210620220923480](https://images.xiaozhuanlan.com/photo/2021/76c0b92bd63aa914676f08a87ae96463.png)
...
![image-20210620230456996](https://images.xiaozhuanlan.com/photo/2021/9f261909cadbee0663bf2bb0dfdeae2e.png)
...
![image-20210620231113255](https://images.xiaozhuanlan.com/photo/2021/4388f92443902c8851388035acba2f10.png)

**第三：把 Mac 中的 Safari 插件兼容 iOS**

如果你已经创建过 Mac 版的 Safari 插件，可以使用命令工具来兼容 iOS 版本：

![image-20210620231339849](https://images.xiaozhuanlan.com/photo/2021/758d65c95288c81f92005547219c04ea.png)

我们一起把 Sea Creator 兼容 iOS，先执行命令：

![image-20210620231650466](https://images.xiaozhuanlan.com/photo/2021/9917b8d672201132aa6869cba9e81b0f.png)

当执行完命令后，会自动打开 Xcode，可以看到兼容 iOS 版本的插件代码：

![image-20210620232023248](https://images.xiaozhuanlan.com/photo/2021/fe426a9243e91cafe50889fdf6ed8ba8.png)
...
![image-20210621084729666](https://images.xiaozhuanlan.com/photo/2021/27439432adcbc186154f0a2c8202ee6c.png)
...
![image-20210621085704657](https://images.xiaozhuanlan.com/photo/2021/0a80ed917034325d8375821f8773c3b6.png)



我们看一看插件中所有的页面是否可以在 iOS 上正常显示，首先看下 tab-page 这个页面，发现字体有点小，这是因为这个页面以前只在 Mac 上运行，需要让这个页面兼容手机端。下面通过 Safari 调试这个页面。

![image-20210626162200525](https://images.xiaozhuanlan.com/photo/2021/eb9ea622184360d860a2e07fcf89c882.png)
...
![image-20210626204413246](https://images.xiaozhuanlan.com/photo/2021/2b5a2adec6a0ae1aa0014869280d1a88.png)
...
![image-20210626161832891](https://images.xiaozhuanlan.com/photo/2021/fcbc89f1f42ab15162691f7c303e143e.png)
...
![image-20210627171555763](https://images.xiaozhuanlan.com/photo/2021/a113d5d7f8631e53b4339850bfb19e1d.png)
...
![image-20210627172417891](https://images.xiaozhuanlan.com/photo/2021/cf2d1978cfce082aa4bee99b53b23fc4.png)

在 ipad 上也可以打开多个 window：

![image-20210627172602074](https://images.xiaozhuanlan.com/photo/2021/ecd2b62b05fcc1c5d4dd047d35f7c10a.png)
...
![image-20210627172756213](https://images.xiaozhuanlan.com/photo/2021/c935cef5143dc026a4608ad16d8f16df.png)

下面这张图，调用  `broswser.windows.getAll()` 或获取到 4 各 window 对象：

![image-20210627173354559](https://images.xiaozhuanlan.com/photo/2021/c08157b236e3ab960af6bfc5a037df56.png)
...
![image-20210626183351560](https://images.xiaozhuanlan.com/photo/2021/ccf5f6d380544556464a752fade605db.png)
...
![image-20210626183618449](https://images.xiaozhuanlan.com/photo/2021/c0d0f0e2b314b11a944dc42158b78673.png)
