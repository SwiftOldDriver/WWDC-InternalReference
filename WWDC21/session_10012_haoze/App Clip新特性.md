...
> 作者：昊泽，iOS 开发者。爱好是给我**女朋友**讲 iOS 的底层原理和帮助她解决她没有思路的线上崩溃。
>
> 审核：乐鹰神骑俊，iOS开发者，目前从事智能家居设备连接控制方向的工作 ：）

![banner](https://images.xiaozhuanlan.com/photo/2021/51841a820a292c2f7eedb0b2d9662ede.png)

本文基于 [Session 10012 - What's new in App Clips](https://developer.apple.com/videos/play/wwdc2021/10012/) 梳理

## 引子

![What's new in App Clips](https://images.xiaozhuanlan.com/photo/2021/8afd62c153a2b99b69ae9ae79e5992b9.png)
...
## 分享优秀的 App Clip
在去年的 Session [Configure and link your App Clips](https://developer.apple.com/videos/play/wwdc2020/10146/)（[《WWDC20 10146 - App Clips 的配置及链接处理》](https://xiaozhuanlan.com/topic/5820361974)），App Clip 的各种唤醒方式是极其惊艳的。包括但不限于 Safari、iMessage、Map、Spotlight search、Siri suggestion widget、NFC、QR Code、App Clip code。接下来让我们看看这些例子。

![discover_app_clip](https://images.xiaozhuanlan.com/photo/2021/4bf6907e19d80870e2848e91d21db709.png)


### Phoenix 2
Phoenix 2 是来自 Firi Games 的一款流行游戏，同时配置了 App Clip。当使用 iOS 设备打开 [Phoenix 2 游戏介绍页](https://firigames.com/phoenix2)，会在 Safari 顶部展示 Safari App Banner。点击 Play 按钮，会调起 App Clip card，在这里就可以启动游戏。
> Safari App Banner 是 App Clip 在 Safari 内的唤醒方式。开发者在网页源代码配置相应的 meta tag，就会在网页顶部展示 Safari App Banner。关于 Banner 的配置，下文会有详细的介绍。

![phoenix_clip_card](https://images.xiaozhuanlan.com/photo/2021/b6ade8f6814a1328c225d8bb2de29032.png)

![phoenix_clip_card_2](https://images.xiaozhuanlan.com/photo/2021/e52228c946b2f5b1dfeb4145701c4f82.png)

当完成游戏的第一关之后，底部会弹起引流到完整 App 的原生浮窗。

![phoenix_full_app](https://images.xiaozhuanlan.com/photo/2021/e193b38835986d03137ea9d843686b90.png)

App Clip 提供了快速展示完整 App 下载提示的入口。参考代码如下

```
// 在 App Clip 工程内添加如下代码
...
*  Phoenix 2 不支持中国大陆的应用商店，当我的设备的应用商店账号归属于中国大陆时，Safari 顶部并不会展示 Safari App Banner，或者仅展示出一个灰底占位底图。灰底占位底图上只有关闭按钮，并无其他信息。推测是苹果的适配问题导致的。
*  注销应用商店账号，处于无账号状态下打开游戏介绍页，仍然不会展示 Safari App Banner。
*  当我将设备的应用商店的 Apple ID 切换成美区账号，再次打开游戏介绍页。此时顶部就会展示出相应的 Safari App Banner。
*  以上每次切换账号前，都会重启设备来规避 Safari 缓存造成的影响。
*  如果 Safari 处于无痕浏览模式，那么顶部的 Safari App Banner 就不会展示。
*  以上测试机型为 iPhone XR (iOS 14.0) / iPhone X (iOS 14.7)

在去年和今年相关的 Session 中，并未提及对非发售区域账号不展示 Safari App Banner 的叙述。但基于测试结果，笔者做出了一个解释。
...
![tiktok_step_one](https://images.xiaozhuanlan.com/photo/2021/bb1dbb0f4d5e04514a9f711ea5a2c8db.png)

点击预览即可展示卡片

![tiktok_step_two](https://images.xiaozhuanlan.com/photo/2021/285e0bd8a913345be9e1eadd477751e7.png)

接着就可以立刻享受视频了。

![tiktok_step_three](https://images.xiaozhuanlan.com/photo/2021/9fc9d31da21f709d728ff87c0387d773.png)
...
![Panera_bread_step_one](https://images.xiaozhuanlan.com/photo/2021/9798be885e51655171574c180074fe13.png)

几秒内，App Clip 就会启动并展示这家商店的菜单。
我可以在这里点单并使用 Apple Pay 支付。 

![Panera_bread_step_two](https://images.xiaozhuanlan.com/photo/2021/dcc8b1b4843d94a85dd09b4ec1729bf2.png)

在 iOS 15 当用户在 Spotlight 搜索商店，例如 Panera。App Clip 会在搜索结果中展示。

![Panera_bread_step_three](https://images.xiaozhuanlan.com/photo/2021/48222fb2b36758908590bdc7bf62185c.png)

借助设备智能化，当用户在 Panera 商店附近。设备会在 Siri suggest 小组件中向用户推荐 App Clip。

![Panera_bread_step_four](https://images.xiaozhuanlan.com/photo/2021/12ae48987725fe8cd23d5f9e67443c9b.png)
...
![Honk——step_one](https://images.xiaozhuanlan.com/photo/2021/d62a72e44655bfabc8e3d7634817bd30.png)

### Primer AR Home Design

Primer AR Home 将 AR 与 App Clip 进行了结合。Primer AR Home 提供了一个帮助用户在 AR 环境中体验墙纸和瓷砖的 App Clip。

![Primer_step_one](https://images.xiaozhuanlan.com/photo/2021/6b1e01c88576e7f4477fc5b345235253.png)

当用户使用 iOS 设备贴近瓷砖上的 App Clip code，就可以在AR环境下体验这种瓷砖在房间中排列的样子。是的，这张 App Clip code 集成了 NFC 功能。

![Primer_step_two](https://images.xiaozhuanlan.com/photo/2021/5981eddd128daa39ba733b64a42e2e8b.png)

> App Clip code 是苹果为 App Clip 量身定做的一种专属二维码，有着独特的设计。App Clip code 不仅支持传统二维码的功能，同时可内置 NFC。下文会介绍如何使用命令行工具生成 App Clip code。

### 小结
自此我们已经看见了各种优秀的 App Clip。它们都有着独特的使用场景和唤醒方式，为我们开发者在以后创建自己的 App Clip 时，提供了优秀的思路。
根据笔者的理解，将 App Clip 大致分为两类
...
在去年的 [Session](https://developer.apple.com/videos/play/wwdc2020/10146/)（[《WWDC20 10146 - App Clips 的配置及链接处理》](https://xiaozhuanlan.com/topic/5820361974)）中，我们可以在网页中配置 `meta tag` 从而在 Safari 和 Safari View Controller 展示 Safari App Banner。

![banner_normal](https://images.xiaozhuanlan.com/photo/2021/33d16223b68e36aff98c3cb352bee08e.png)

在 iOS 15 我们可以在 `meta tag` 添加新的配置代码，从而可以展示全尺寸的 App Clip card。卡片会在网页的中部弹出。用户可以直接在这里开启我们的 App Clip。但是如果用户点击 "View in Safari"，Safari 会记录他们的选择。再次打开次网页就不会展示该卡片，而是会展示原来的 banner 样式。

![banner_card_style](https://images.xiaozhuanlan.com/photo/2021/742a77b8bd38f5047736d930332ad643.png)
...
![FoodGrid——banner_stype_one](https://images.xiaozhuanlan.com/photo/2021/ee0447b10eab3606679b1dcfec17f8d4.png)
...
![card_mode_config](https://images.xiaozhuanlan.com/photo/2021/bc8fc6361d68b11123d57a3d81db090e.png)

![FoodGrid——card_stype_one](https://images.xiaozhuanlan.com/photo/2021/43abddbce2b912c80d318d62998776ca.png)

用户就可以直接在第三方应用内打开 Fruta 的 App Clip，并享受美味的冰沙了。

![FoodGrid——card_stype_two](https://images.xiaozhuanlan.com/photo/2021/6d729246a0deb4aaffb4106090f569ac.png)
...
![new_create_exper](https://images.xiaozhuanlan.com/photo/2021/812a5535b45e22f8ea8413387af71619.png)
...
[Session - 10146 Configure and link your App Clips](https://developer.apple.com/videos/play/wwdc2020/10146/)（[《WWDC20 10146 - App Clips 的配置及链接处理》](https://xiaozhuanlan.com/topic/5820361974)）
...
![demo_step_1](https://images.xiaozhuanlan.com/photo/2021/f8c00d0b9a0e02c38552048c4f90f950.png)
...
![demo_step_2](https://images.xiaozhuanlan.com/photo/2021/68934f07a02c4caa8bd699f06a5d5fb3.png)

![demo_step_3](https://images.xiaozhuanlan.com/photo/2021/bd2ecba37875d6af709693185e19da16.png)

在 App Clip extension 的 schema 中添加环境变量 `_XCAppClipURL`，value 就是上面映射的链接。

![demo_step_4](https://images.xiaozhuanlan.com/photo/2021/021724ddcdd2e5f5bbc7ccb2d4844a96.png)
...
![demo_step_5-7](https://images.xiaozhuanlan.com/photo/2021/ed956914066f5e4fb8e0de0537260dde.png)

我们发现，唤起了 App Clip Card 是空白一片的。因为我们并没有对  App Clip Card 进行任何配置。
在配置卡片前，让我们先了解下什么是 App Clip Card.

##### 关于 App Clip Card 
对于普通用户，他们的 App Clip 体验源于 App Clip Card。卡片会展示 App Clip 的标题、副标题、介绍 App Clip 的品牌和风格的图像和操作按钮。

![app_clip_card_ino](https://images.xiaozhuanlan.com/photo/2021/10fd2f9a7cf94af31a9891568acf9884.png)
上面空白一片的 App Clip Card 无法在测试期间展示上线后的样式，也无法对细节进行微调。因此苹果提供了本地体验功能，帮助开发者在本地开发期间对  App Clip Card 进行本地配置。


#### 本地体验配置
打开设置 >> 开发者 >> Local Experiences >> Register Local Experience，即可开始配置你的专属本地体验。

![local_ex_1](https://images.xiaozhuanlan.com/photo/2021/f9e59dc63d55a612d2a3d0e299097086.png)

本地配置的 `URL PREFIX` 要与 App Clip Extension 的 `associated domain` 对应，`BUNDLE ID` 要与 App Clip Extension 的 `bundle ID` 对应。

![local_ex_2](https://images.xiaozhuanlan.com/photo/2021/c487ecc88af581b04f6f07be8dcf4fa5.png)

再次使用设备扫描刚才生成的二维码，就会发现弹出的 App Clip Card 同配置一致了。

![custome_clip_card](https://images.xiaozhuanlan.com/photo/2021/bb8e4e5f397e6917e3744af0f8c82794.png)


本地体验也是有局限性的，仅支持以下几种唤醒方式。可以看出这几种唤醒方式都是同链接有关。

![wake_up_style](https://images.xiaozhuanlan.com/photo/2021/2dac8541ff4aa240be27e5c7046042cb.png)
...
>  App Clip 有两种体验方式 Default App Clip Experience 和  Advanced App Clip Experiences。
> App Clip 通过 Safari App Banner 或者 iMessage app 中的符合domain 要求的 URL 下载和启动。这种方式称为 Default App Clip Experience。对于更复杂的唤醒情况，可以根据 URL 的不同、地理位置的不同，来提供不一样的 App Clip Card。这部分需要在 App Store Connect 进行配置。这类启动方式被称为 Advanced App Clip Experiences。以下几种情况需要配置 Advanced App Clip Experiences
> - App Clip 支持所有的唤醒方式，包括 Map、Spotlight search、App Clip Codes 等。
...
![app_clip_code——all_style](https://images.xiaozhuanlan.com/photo/2021/6edb7355c7cce5eb9b5b7df6f7e241b1.png)
...
![app_code_encode_logic](https://images.xiaozhuanlan.com/photo/2021/82aaedd55d3637f40d2043f7656bb2f5.png)
...
![all_style_code](https://images.xiaozhuanlan.com/photo/2021/8209a242b6d181e37e1486abd7acd09e.png)
...
Mac 的终端工具默认是没有集成 App Clip Code 生成器的。首先要去 [Apple Developer website](https://developer.apple.com/download/all/?q=App+Clip) 进行下载。

![tool_download_info](https://images.xiaozhuanlan.com/photo/2021/f6310021d91aa2c59c46af4751fdf7a2.png)

安装成功后，打开我们的终端，输入 `AppClipCodeGenerator templates`，就可以浏览所有可用的模板。

![code_all_templates](https://images.xiaozhuanlan.com/photo/2021/e1781386fcc00bb5d3c0f167770640c4.png)

那么这些模板都长什么样子呢？我们可以使用该路径 `/Library/Developer/AppClipCodeGenerator/SampleTemplates` 预览所有模板的样式。

![code_show_templates](https://images.xiaozhuanlan.com/photo/2021/69fe712d04367821c3a19aaecab76f6c.png)

Template_ID_16 看起来不错，所以我准备使用这个模板来生成 WWDC20 内参小专栏的 App Clip Code。

![template_16](https://images.xiaozhuanlan.com/photo/2021/42ba2d671814f65f5c373a0669211e8c.png)
...
<div align=center><img src="qvf5ynk5g.bkt.clouddn.com/mweb/wwdc20.svg" width="50%"></div>
...
![custom_app_clip_code](https://images.xiaozhuanlan.com/photo/2021/e7adfea2d56e48d2672d5c05983e44bc.png)

![clear-messaging](https://images.xiaozhuanlan.com/photo/2021/a8e88d1f011fe4d9c957f8649e440f80.png)
...
![guidance_3](https://images.xiaozhuanlan.com/photo/2021/5655b649ec2cfa99a0a306f8e73eb01a.png)

![guidance_2](https://images.xiaozhuanlan.com/photo/2021/a6346c967a4617c032942fc6552e4da7.png)

![guidance_1](https://images.xiaozhuanlan.com/photo/2021/488ae26d7964a7c2e33af1c0573d8d17.png)
