...
> 作者：Sean，目前就职于滴滴网约车，好爱机车、吉他、旅游，坐标长期北京，欢迎约酒干饭！[博客地址](https://www.jianshu.com/u/9ef127e6fca4)。
> 
> 审核：酷酷的哀殿，编译器、构建系统爱好者，[酷酷的哀殿](https://ai-chan.top/)
...
![Xcode Menu Product Analyze](https://images.xiaozhuanlan.com/photo/2021/eca27f60b58a155b1d4f400c0d4c5edb.jpg)

像编译一样，需要等待一段时间，然后被静态分析器捕获的问题就以蓝色的感叹号 在 Xcode 上方显示出来。也可以在 issue navigator 中查看蓝色的分析器捕获的问题。

以下是目前分析器支持捕获的错误类型：

![问题种类](https://images.xiaozhuanlan.com/photo/2021/ae27cd2f2414ca2a51cfb81fbe42aa87.jpg)
...
![return null value](https://images.xiaozhuanlan.com/photo/2021/e08c1ac267591cecc9595e13a5b1b37f.jpg)
...
![code path](https://images.xiaozhuanlan.com/photo/2021/68c7c92b15d5a28dcaa72ec18dd95003.jpg)
...
![fixed](https://images.xiaozhuanlan.com/photo/2021/e26d81a8fcaac0a99cc5948eb036653f.jpg)
...
![NSAssertSideEffectDemo](https://images.xiaozhuanlan.com/photo/2021/ebaa01cfaed3e6eb4e469a518b50827b.jpg)
...
![NSAssertSideEffectDemoIssue](https://images.xiaozhuanlan.com/photo/2021/09b81d3bd8201fecca0f33061b5bcba5.jpg)

当然这个代码也很好修复，我们只需要把累加操作外置到NSAssert函数的上面即可：

![NSAssertSideEffectFixed](https://images.xiaozhuanlan.com/photo/2021/bc08ed79bd5698cb28c8ce03c045de5d.jpg)


下面是一个很常见的死循环的案例，这种稍微复杂一些的逻辑，乍眼一看，似乎没有什么问题：

![InfiniteLoopDemo](https://images.xiaozhuanlan.com/photo/2021/74a01ec5d226054b44e6d6804e0aa99d.jpg)

这段代码中，做了一个二维循环，但是在内层的循环中，没有对 `column` 做递增，而是做了 `value` 的递增，这个问题虽然会隐晦，但是新版本的静态检查器可不会错过它！

如图，它会捕获这个问题：

![InfiniteLoopDemoIssue](https://images.xiaozhuanlan.com/photo/2021/61e2637e5187975ccb6a4ec492f32e79.jpg)

把 `value` 替换成 `column` 修复这个问题：

![InfiniteLoopDemoFixed](https://images.xiaozhuanlan.com/photo/2021/60c25cbba3bcfc265599bcd66d5f3471.jpg)
...
![DuringBuild](https://images.xiaozhuanlan.com/photo/2021/37e06ade5e20a2e8306f4d23e712782e.jpg)
...
![专项检查配置](https://images.xiaozhuanlan.com/photo/2021/e30018af7a2228dcfc8e26047b68ae30.jpg)

例如，如果项目有严格的安全检查，可以打开下图中选中的这些配置项目：

![专项——安全](https://images.xiaozhuanlan.com/photo/2021/7762711bd2d024d92733646353ab8ac1.jpg)

如果静态分析器抛出的某一类问题你并不需要关注，你想忽略掉这类问题，可以在下面这些选项中找到并关闭这类策略，从而使得静态分析器捕获到的问题对你的工程更有参考意义：

![定制关注问题](https://images.xiaozhuanlan.com/photo/2021/ba2ba3a5d44c5dafe378c332e3027a04.jpg)

### 单个文件的分析

我们也可以对单个文件进行分析，选中你想要分析的文件，在 `Product` 菜单栏下选择 `Analyze ’FileName‘` 即可进行对这个文件进行分析，并且不会分析import关联的所有文件。

![Single File Analyze](https://images.xiaozhuanlan.com/photo/2021/a4e507828876bd13e26bbeaa25e190b6.jpg)
...
![LLVM中Clang静态分析器模块源码位置](https://images.xiaozhuanlan.com/photo/2021/cb2a9a9c1dda4ba37bcba036890410f7.jpg)
...
![ArrayBoundChecker.cpp](https://images.xiaozhuanlan.com/photo/2021/243fcfb989277992ca2a2a5a28b12479.jpg)
...
![编译后的scan-build和view](https://images.xiaozhuanlan.com/photo/2021/92c5b6bae43cbc207cec09bf4c94094a.jpg)
