...
- [WWDC21 10141 - 使用 HLS 内容调度提升全球范围流媒体的可用性](https://xiaozhuanlan.com/topic/2956103478)
...
![](https://images.xiaozhuanlan.com/photo/2021/a04a987dbd20ab250f6960eea0a06971.png)
...
![](https://images.xiaozhuanlan.com/photo/2021/04b841905bbec543409f8a109d03d019.png)

当 AVURLAsset 解析完 m3u8 文件后，就可以通过访问 variants 属性查看 HLS 媒体的属性了。

AVAssetVariant 的具体结构大致如下图所示。

![](https://images.xiaozhuanlan.com/photo/2021/1f11fb4e4af3678f1c927afac3c0bdda.png)
...
> 如果你对 HLS 下载还不了解，可以观看 [WWDC20-10655](https://developer.apple.com/videos/play/wwdc2020/10655/)（[《WWDC20 10655 - 了解如何下载并离线播放 HLS》](https://xiaozhuanlan.com/topic/6985071234)）了解详尽信息。
...
可以看到，有了 NSPredicate 的加入，HLS 下载的配置范围变得更广，不局限于固定的几个 key，配置起来也更加灵活。通过 NSPredicate 的方式，我们的代码可读性会更高，代码量也会更少，而且配置可以更加方便地下发。
...
AVAssetDownloadConfiguration 能接收一个主内容配置和多个辅助内容配置。辅助内容配置的作用是进一步约束你的配置选项，避免因为下载到多个满足主内容配置的不同资源，而导致下载的内容增加。

![](https://images.xiaozhuanlan.com/photo/2021/29c889ae1a5219c9cfc0a65bcc8908d2.png)
